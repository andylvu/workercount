...
def on_click(x, y, button, pressed):
    global right_click_pressed, right_click_released
...
while True:
    try:
        ...
        if mouse_in_green and right_click_pressed and right_click_released == True:
            working_count += scv + scv_multi

        if right_click_pressed and right_click_released == True:
            # Perform your action here
            print("Right click pressed and released")
