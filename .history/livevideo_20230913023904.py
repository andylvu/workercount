...
def on_click(x, y, button, pressed):
    global right_button_pressed, right_click_counted
    ...
    if button == Button.right:
        if pressed:
            ...
            if right_button_pressed and not right_click_counted:
                # Register a right click event only if the button was pressed and no right click has been counted
                right_click = True
                right_click_counted = True
                print('Right click')
    else:
        # If any other button is pressed or released, reset the flags
        right_button_pressed = False
        right_click_counted = False
