    ...
    try:
       ...
       # Perform template matching for the minerals
        ...
        for pt_candidate in zip(*loc1[::-1]):
            ...
            if pt_candidate[0] <= mouse_x <= pt_candidate[0] + template_width1 and pt_candidate[1] <= mouse_y <= pt_candidate[1] + template_height1:
                mouse_in_green = True
                pt = pt_candidate  # Assign pt if mouse is inside the green rectangle
            else:
                mouse_in_green = False
        ...
        print("Template Width:", template_width1)
        print("Template Height:", template_height1)
        print("Mouse in Green:", mouse_in_green)
        print()
