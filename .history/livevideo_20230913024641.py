...
def on_click(x, y, button, pressed):
    global right_button_pressed, right_clicks
    ...
    right_button_pressed = False  # Reset the flag if any other button is pressed
...
while True:
    try:
        ...
        if mouse_in_green and right_button_pressed == True:
