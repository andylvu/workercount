...
# function for template matching and object counting
def match_templates():
    global scv, scv_multi, working_count, right_clicks, mouse_in_green
    ...
    while True:
       ...
       # Perform template matching for the minerals
        ...
        for pt_candidate in zip(*loc1[::-1]):
            # calculate adjusted mouse coordinate for green rectangle
...
template_matching_thread = threading.Thread(target=match_templates)
