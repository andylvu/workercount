...
screen_capture = cv2.VideoCapture(0)  # You might need to specify the screen capture device (e.g., 0 for the default screen)
...
# flag to check if the mouse is inside the green rectangle
...
cv2.namedWindow("Live Desktop Video", cv2.WINDOW_NORMAL)
cv2.resizeWindow("Live Desktop Video", 1920, 1080)  # Replace with your desired width and height
...
while True:
    try:
        ...
        current_frame = current_frame[y:y+center_height, x:x+center_width]
