...
while True:
    try:
        ...
        # Perform template matching for the minerals
            ...
            num_matches1 = len(loc1[0])
            print(num_matches1, 'minterlas')
            num_matches2 = len(loc2[0])
            print(num_matches2, 'scv')
            num_matches3 = len(loc3[0])
            print(num_matches3, 'scv_multi')
            ...
            for i in range(0, num_matches1, 10):
